...
const Hero = () => {
  return (
    <div>
        ...
        <div className='w-screen h-screen flex md:mt-[28px] mt-0 z-9 justify-center items-center'>
            <Image src={heroimage}
             alt='image'
              className='relative  w-screen h-[716px] rounded-[5px] border object-cover '/>
            <div className={`absolute w-[400px] h-[550px] md:w-[599px] md:h-[331px] flex flex-col justify-center  text-center md:text-left md:bottom-0 md:top-80 md:left-56  ${montserrat.className} gap-[35px] text-[#FAFAFA] `}>
              ...
              <Button title='SHOP NOW' style='bg-[#2DC071]'/>
          </div>
          </div>

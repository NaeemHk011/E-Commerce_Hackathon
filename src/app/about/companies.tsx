  ...
  return (
    <div>
        <div className='w-screen h-[1000px] md:h-[479px] flex flex-col justify-center items-center bg-[#FAFAFA]'>
            <div className='w-[400px] md:w-[1050px] h-[1192px] md:h-[479px] py-20 gap-6 flex flex-col justify-center items-center '>
                <div className={` ${montserrat.className} w-[350px] md:w-[864px] h-[240px] md:h-[120px] gap-[30px] flex flex-col justify-center items-center`}>
                 ...
                 {/* logos */}
                <div className='w-[400px] md:w-[1054px] h-[952px] md:h-[175px] flex flex-col md:flex-row justify-center items-center py-[50px] gap-[60px] md:gap-[30px]'>

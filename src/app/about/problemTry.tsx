  ...
  return (
    <div>
        <div className='w-screen h-[1985px] md:h-[1265px] md:mt-10 mt-0 flex flex-col justify-center items-center'>
            {/* Problems trying */}
            <div className='w-screen h-[500px] md:h-[236px] flex justify-center items-center bg-white'>
                <div className='w-[1018px] h-[188px] mx-auto flex flex-col md:flex-row justify-center items-center gap-[60px]'>
                    <div className='w-[394px] h-[188px] flex justify-center items-center py-6 gap-20'>
                        <div className='w-[381px] md:w-[394px] text-center md:text-left h-[140px] gap-6'>
                    ...
                    <div className='w-[306px] md:w-[529px] h-10 gap-12'>
                        <p className={`${montserrat.className} font-normal text-sm leading-5 `}>Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </p>
                    </div>
                </div>
            </div>
        {/* Ranking */}
        <div className='w-screen h-[1006px] md:h-[264px] mt-10 md:mt-0 flex justify-center items-center '>
            <div className='w-[400px] md:w-[1050px] h-[806px] md:h-[264px] flex justify-center items-center py-20 gap-[50px] '>
        ...
        <div className='w-screen  flex justify-center items-center bg-[#FFFFFF]'>
            <div className='w-[400px] md:w-[1050px] h-[477px] md:h-[764px] flex justify-center items-center'>
